...
RUN cd /opt && \
    curl -LO https://releases.mattermost.com/3.2.0/mattermost-team-3.2.0-linux-amd64.tar.gz && \
    tar xf mattermost-team-3.2.0-linux-amd64.tar.gz &&\
